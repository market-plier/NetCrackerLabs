...
public class OpticFiberImmutableWrapper<A extends Device,B extends Device> extends OpticFiberWrapper<A,B> {

    public OpticFiberImmutableWrapper(OpticFiber wrappee) {
        this.wrappee = wrappee;
    }

    @Override
    public Mode getMode() {
        return wrappee.getMode();
    }
